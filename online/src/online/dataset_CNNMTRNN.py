...
class OnlineDataSet:
    def __init__(self,  device, high_freq, mode="normal"):
    ...
    def cal_features(self, high_freq):
        ...
        self._img_feature = self.get_img_feature(self._imgs[-1])
    ...
    def get_connected_data(self):
        return self._connected_data, self._img_feature
    ...
    def get_img_feature(self, img):
        ...
        return img_tensor  # img_feature.to("cpu").detach().numpy()[0]
    ...
    def save_inputs(self, outputs, cs_states, output_imgs):
        ...
        for i, img in enumerate(output_imgs):
            torchvision.utils.save_image(
                img, output_img_dir + "/{:03d}.png".format(i)
            )
