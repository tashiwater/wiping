...
from dataset_pb import OnlineDataSet as MyDataSet
from model.PBMTRNN import PBMTRNN as MTRNN
...
model_path = MODEL_DIR + "MTRNN/pb/5000/{}_{}.pth".format(cf_num, cs_num)
...
inputs_t, img = dataset.get_custom_data()
net.set_pb(img)
