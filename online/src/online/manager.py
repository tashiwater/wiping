...
class Manager(ManagerBase):
    def set_MTRNN(self):
        ...
        model_path = self._model_dir + \
            "MTRNN/0101/io2cf10cs30/5000/{}_{}.pth".format(
...
if __name__ == "__main__":
    before_scale = [
        ...
        [-0.09466658832071984, 0.04475016106103746],
        [-0.08339182952976021, 0.35081116966400616],
        [-0.24754004934167334, 0.1188394669540154],
        [-0.19846142759379481, 0.26300366924408314],
        [-0.08902924221475353, 0.3653148614738753],
        [-0.09232791676470975, 0.08040731436167627],
        ...
        [-1.8076667785644531, 1.9323334693908691],
    ]
    manager = Manager()
