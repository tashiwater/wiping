...
Edited by Hiroyuki Oka, Tokyo Robotics Inc. (2018-10-15)
-------------------
* Use SetVelocity instead of SetPosition with position-controlled prismatic joint in DefaultRobotHWSim::writeSim() in order to avoid SetPosition jump problem of prismatic joint.
* Check p-gain in DefaultRobotHWSim::initSim() in order to avoid useless error log.
* Add prefix of "torobo" to namespace of gazebo_ros_control.
