...
def main():
    ...
    try:
        ...
        action_datafile=open("/home/assimilation/Desktop/offline_test1/Norm_Angles15.txt")
        ...
        for i in range(data_length-1):
            ...
            #j1=normalization(float(line[0]),[-0.9,0.9],[0,35])
            #j2=normalization(float(line[1]),[-0.9,0.9],[-40,5])
            #j3=normalization(float(line[2]),[-0.9,0.9],[-5,20])
            #j4=normalization(float(line[3]),[-0.9,0.9],[0,15])
            #j5=normalization(float(line[4]),[-0.9,0.9],[-5,5])
            #j6=normalization(float(line[5]),[-0.9,0.9],[-5,5])
            #j7=normalization(float(line[6]),[-0.9,0.9],[-5,5])
            # Executes an action.
